...
export default function RootLayout({
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "홈",
        "item": "https://my-local-info-3pm.pages.dev"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "블로그",
        "item": "https://my-local-info-3pm.pages.dev/blog"
      }
    ]
  };
  ...
  return (
    <html
      lang="ko"
      <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8997765300286040"
